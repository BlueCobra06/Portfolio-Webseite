    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-full bg-gradient-to-br from-slate-900 to-gray-900 ">
            <div className="w-full flex flex-col items-center p-10 mt-35">   
                <div className="flex flex-row items-center gap-2 mb-4 bg-white/10 rounded-2xl p-8 border border-white/10 mb-8 w-full lg:max-w-2xl md:max-w-xl sm:max-w-lg">
                ...
                <section className="border border-white/10 bg-white/5 backdrop-blur-lg rounded-2xl p-10 w-full lg:max-w-2xl md:max-w-xl sm:max-w-lg">  
